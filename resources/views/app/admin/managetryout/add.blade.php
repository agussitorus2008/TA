...
<div class="container">
    <form action="{{ route('admin.managetryout.add') }}" method="POST">
        @csrf
        <div class="row m-3">
            <div class="form-row align-items-center">
                <div class="form-group col-md-4">
                    <label for="nama_tryout">Nama Tryout :</label>
                    <input type="text" class="form-control" name="nama_tryout" id="nama_tryout" value="{{ $newTryoutName }}">
                </div>
                <div class="form-group col-md-3">
                    <label for="active">Tahun Tryout :</label>
                    <input type="number" class="form-control" name="tahun" id="tahun" value="{{ $tahunSekarang }}">
                </div>
    ...
    <div class="row justify-content-center text-center">
        ...
        <div class="row justify-content-center mt-4 mr-3 ml-3">
            <div class="col-xl-6">
                <h4>PPU</h4>
                <input type="number" class="form-control mb-2" name="t_ppu" id="t_ppu" value="{{ old('t_ppu') }}" required>

                <h4>PU</h4>
                <input type="number" class="form-control mb-2" name="t_pu" id="t_pu" value="{{ old('t_pu') }}" required>

                <h4>PM</h4>
                <input type="number" class="form-control mb-2" name="t_pm" id="t_pm" value="{{ old('t_pm') }}" required>

                <h4>PK</h4>
                <input type="number" class="form-control mb-2" name="t_pk" id="t_pk" value="{{ old('t_pk') }}" required>
            </div>
            <div class="col-xl-6">
                <h4>LBI</h4>
                <input type="number" class="form-control mb-2" name="t_lbi" id="t_lbi" value="{{ old('t_lbi') }}" required>

                <h4>LMB</h4>
                <input type="number" class="form-control mb-2" name="t_lbe" id="t_lbe" value="{{ old('t_lbe') }}" required>

                <h4>PMB</h4>
                <input type="number" class="form-control mb-2" name="t_pbm" id="t_pbm" value="{{ old('t_pbm') }}" required>
            </div>

            <div class="row justify-content-center text-center mt-3 mb-4">
                <div class="col-2">
                    <h4>Total Soal</h4>
                    <input type="number" class="form-control mb-2" name="total" id="total" value="{{ old('total') }}" readonly>
                </div>
            </div>            
