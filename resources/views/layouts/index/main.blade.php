...
<html lang="zxx">
    ...
    <body>  
               ...
               <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="discover-img">
                            <img src="assets/img/discover.png" alt="discover image">
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="discover-text">
                            <h2>Discover the Talented  Designers in The World</h2>
        ...
        <section class="how-works ptb-100">
            <div class="container">
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="how-works-text">
                            <div class="section-title">
                                <h2>How Jovie Works For You</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Quis ipsum spendisse ultrices gravida. Risus commodo viverra.</p>
                            </div>

                            <div class="media">
                                <i class='bx bx-door-open mr-3'></i>
                                <div class="media-body">
                                    <h5 class="mt-0">Find the Right Job</h5>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ipsum suspendisse ultrices.
                                </div>
                            </div>

                            <div class="media">
                                <i class='bx bx-search-alt-2 mr-3'></i>
                                <div class="media-body">
                                    <h5 class="mt-0">Research Companies</h5>
                                    Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. ipsum suspendisse ultrices.
                                </div>
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="how-works-img">
                            <img src="assets/img/how-works.png" alt="how works">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="testimonial-style-two testimonial-style-three pt-100">
            <div class="container">
                <div class="section-title text-center">
        ...
        <!-- Blog Section Start -->
        <section class="blog-section ptb-100 pb-70">
            <div class="container">
                <div class="section-title text-center">
